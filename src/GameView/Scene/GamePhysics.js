...
var GamePhysics = cc.Scene.extend({
    ui:null,
    gun:null,
    onEnter:function()
    {
        this._super();
        this.ui = flax.assetsManager.createDisplay(resGameMove.physics, "gameUI", {parent:this});
...
//        ui.getCollider("hole").debugDraw();
    ...
    onClick:function(touch, event)
    {
        ...
        var ball = flax.assetsManager.createDisplay(resGameMove.physics, "b" + flax.randInt(0, 5), {parent:this, zIndex: 99}, true);
...
//        }
    ...
    onCollid:function(collider0, collider1)
    {
        ...
        if(ball){
            ...
            var effect = flax.assetsManager.createDisplay(resGameMove.physics, "collideEffect", {parent:this, zIndex: 999, autoDestroyWhenOver:true}, true);
